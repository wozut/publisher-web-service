...
fun List<Pair<TclDriver, TclDriverScore>>.findRelevantDriverScorePairsWithHighestScore(
    range: Double
): List<TclDriverAndScore> {
    val allSorted = findRelevantDriverScorePairs()
        .sortedByDescending { pair: Pair<TclDriver, TclDriverScore> -> pair.second }
