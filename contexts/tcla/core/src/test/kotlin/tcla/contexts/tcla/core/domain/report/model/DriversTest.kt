...
class DriversTest {
    ...
    @Test
    fun `there is a subset of relevant drivers`() {

        val expectedRelevantDrivers = setOf(
        ...
        assertThat(Drivers.relevantDrivers).containsExactlyInAnyOrder(*expectedRelevantDrivers.toTypedArray())
    }
}
